 ...
 * unique. - Perform sorting on this collection based on the employee Name. (ascending order by Employee Name)
 * 
 * @author Prateek Jain
 *
 */
public class SortingByEmployeeName {
	public static void main(String[] args) {
		...
		while (!exit) {
			try {
				System.out.println("\n1) Add employee in the employeesList"+ "\n2) Display all employees sorted By name"+ "\n3) Exit.");
				 ...
				 * case 2: display all employees sorted by name
				...
				case 2:
					 ...
					 * else display all entries present in employeeslist after sorting by name
					 */
					if(employeesList.isEmpty()) {
						System.out.println("No employee entry is present");
					} else {
						collection.sort(employeesList, Employee.NameComparator);
