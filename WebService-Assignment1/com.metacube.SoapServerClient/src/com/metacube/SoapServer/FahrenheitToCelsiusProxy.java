...
public class FahrenheitToCelsiusProxy implements com.metacube.SoapServer.FahrenheitToCelsius {
  private String _endpoint = null;
  private com.metacube.SoapServer.FahrenheitToCelsius fahrenheitToCelsius = null;
  ...
  private void _initFahrenheitToCelsiusProxy() {
    try {
      fahrenheitToCelsius = (new com.metacube.SoapServer.FahrenheitToCelsiusServiceLocator()).getFahrenheitToCelsius();
  ...
  public com.metacube.SoapServer.FahrenheitToCelsius getFahrenheitToCelsius() {
    if (fahrenheitToCelsius == null)
      _initFahrenheitToCelsiusProxy();
