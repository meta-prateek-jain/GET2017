...
public class FahrenheitToCelsiusServiceLocator extends org.apache.axis.client.Service implements com.metacube.SoapServer.FahrenheitToCelsiusService {
    ...
    private java.lang.String FahrenheitToCelsius_address = "http://localhost:8080/com.metacube.SoapServer/services/FahrenheitToCelsius";
    ...
    public com.metacube.SoapServer.FahrenheitToCelsius getFahrenheitToCelsius() throws javax.xml.rpc.ServiceException {
    ...
    public com.metacube.SoapServer.FahrenheitToCelsius getFahrenheitToCelsius(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.SoapServer.FahrenheitToCelsiusSoapBindingStub _stub = new com.metacube.SoapServer.FahrenheitToCelsiusSoapBindingStub(portAddress, this);
	...
	public java.rmi.Remote getPort( Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.SoapServer.FahrenheitToCelsius.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.SoapServer.FahrenheitToCelsiusSoapBindingStub _stub = new com.metacube.SoapServer.FahrenheitToCelsiusSoapBindingStub(new java.net.URL(FahrenheitToCelsius_address), this);
                _stub.setPortName(getFahrenheitToCelsiusWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://SoapServer.metacube.com", "FahrenheitToCelsiusService");
    }
	...
	public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://SoapServer.metacube.com", "FahrenheitToCelsius"));
        }
